...
class MediaViewAdapter(private val context:Context?, val dataHolder: List<Story>, private val resultLauncher: ActivityResultLauncher<Intent>, private val showDownload: (Boolean) -> Unit) : RecyclerView.Adapter<MediaViewAdapter.MyViewHolder>() {
    var isEnabled= false
    var loading=false
